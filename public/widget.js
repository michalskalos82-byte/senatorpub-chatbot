(function () {
  ...
  style.textContent = `
    #sp-chat-button{position:fixed;right:22px;bottom:22px;width:62px;height:62px;border-radius:50%;border:0;background:#17110d;color:#fff;font-size:26px;cursor:pointer;box-shadow:0 8px 24px rgba(0,0,0,.25);z-index:999999}
    ...
    #sp-chat-header{background:#17110d;color:#fff;padding:15px 16px;font-weight:700;display:flex;justify-content:space-between;align-items:center}
    #sp-chat-close{background:transparent;border:0;color:#fff;font-size:22px;cursor:pointer}
    #sp-chat-messages{flex:1;padding:14px;overflow-y:auto;background:#f6f1ea}
    ...
    .sp-user{background:#17110d;color:#fff;margin-left:auto}
